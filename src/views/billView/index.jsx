                ...
                >
                    <Grid container direction="column" spacing={1} className="no-break" sx={{ minHeight: 'auto' }}>
                        ...
                        <Grid item>
                            ...
                            >
                                ...
                                <Box sx={{ flexGrow: 1, textAlign: { xs: 'left', sm: 'right' } }}>
                                    <Typography
                                        variant="subtitle1"
                                        sx={{ fontWeight: 600, fontSize: { xs: '0.85rem', sm: '0.95rem' }, mb: 0.2, color: 'white' }}
                                    >
                                        Universal car wash sàrl
                                    </Typography>
                                    <Typography
                                        variant="caption"
                                        sx={{ fontSize: { xs: '0.7rem', sm: '0.8rem' }, color: 'white', opacity: 0.9 }}
                                    >
                        ...
                        <Grid item>
                            ...
                            >
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                    ...
                                    <Typography
                                        variant="subtitle1"
                                        sx={{ fontWeight: 600, color: 'primary.main', fontSize: { xs: '0.95rem', sm: '1.05rem' } }}
                                    >
                        ...
                        <Grid item>
                            <Box
                                className="print-bg"
                                sx={{ bgcolor: 'black', color: 'white', p: { xs: 1, sm: 1.5 }, mt: 1, borderRadius: 1 }}
                            >
                                <Box sx={{ textAlign: 'center', mb: 0.5 }}>
                                    <Typography
                                        variant="subtitle1"
                                        sx={{ color: '#FF2400', fontWeight: 700, fontSize: { xs: '1rem', sm: '1.1rem' } }}
                                    >
